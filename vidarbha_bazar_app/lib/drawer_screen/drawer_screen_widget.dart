...
class DrawerScreenWidget extends StatefulWidget {
  DrawerScreenWidget({Key key}) : super(key: key);

  @override
  _DrawerScreenWidgetState createState() => _DrawerScreenWidgetState();
}

class _DrawerScreenWidgetState extends State<DrawerScreenWidget> {
