...
class AstrologerProfileWidget extends StatefulWidget {
  AstrologerProfileWidget({Key key}) : super(key: key);

  @override
  _AstrologerProfileWidgetState createState() =>
      _AstrologerProfileWidgetState();
}

class _AstrologerProfileWidgetState extends State<AstrologerProfileWidget> {
