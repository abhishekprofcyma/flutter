import 'package:astrology_app_design/home_chat_1/home_chat1_widget.dart';
...
class HomeChatWidget extends StatefulWidget {
  HomeChatWidget({Key key}) : super(key: key);

  @override
  _HomeChatWidgetState createState() => _HomeChatWidgetState();
}
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Waitlist joined for chat\nwith astrologer Ashish\nwait time : 1 min',
                                style: GoogleFonts.getFont(
                                  'Open Sans',
                                  fontWeight: FontWeight.w600,
                                  fontSize: 14,
