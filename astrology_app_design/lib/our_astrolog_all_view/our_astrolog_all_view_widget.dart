...
class OurAstrologAllViewWidget extends StatefulWidget {
  OurAstrologAllViewWidget({Key key}) : super(key: key);

  @override
  _OurAstrologAllViewWidgetState createState() =>
      _OurAstrologAllViewWidgetState();
}

class _OurAstrologAllViewWidgetState extends State<OurAstrologAllViewWidget> {
